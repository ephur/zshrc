...
#POWERLEVEL9K_LEFT_SEGMENT_SEPARATOR="\uE0B4" # (lump)
POWERLEVEL9K_LEFT_SEGMENT_SEPARATOR_ICON="\uE0C8" # waveform
POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR_ICON="%F{$(( ${DEFAULT_BACKGROUND} - 2 ))}|%f"
POWERLEVEL9K_RIGHT_SEGMENT_SEPARATOR_ICON="\uE0B6"
POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR_ICON="%F{$(( ${DEFAULT_BACKGROUND} - 2 ))}|%f"
...
POWERLEVEL9K_DIR_SHORTEN_DIR_LENGTH=5
POWERLEVEL9K_DIR_SHORTEN_STRATEGY=""
